    ...
    <section className="w-full min-h-[calc(100vh-80px)] flex items-center py-12 lg:py-20 bg-background text-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <MotionWrapper className="flex justify-center items-center lg:justify-start relative group h-[500px] max-w-md mx-auto w-full">
            ...
            <Image
              ...
              fill
              className="object-cover z-10 p-4 grayscale group-hover:grayscale-0 transition-all duration-300"
              priority
            />
          ...
          <div className="flex flex-col space-y-8">
             <MotionWrapper>
                ...
                <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold font-headline tracking-tighter font-stretch-condensed -ml-1">
                    ...
                    <span className="block italic text-primary">do i need to be specific?</span>
